...
const FeaturesBox: React.FC<FeaturesBoxProps> = ({
  ...
  return (
    <div
      ref={ref}
      className={`w-full sm:w-[48%] md:w-[220px] lg:w-[260px] h-[370px] p-4 rounded-3xl flex flex-col items-center justify-around shadow-sm bg-white transform transition duration-300 hover:scale-105 hover:shadow-lg ${
