...
import benefitImage from "../../../assets/Frame 8616.png";
...
const Benefits: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-[90%] flex flex-col-reverse md:flex-row justify-center md:justify-between gap-8 md:gap-0 items-center py-6">
        {/* Text */}
        <div
          ref={textRef}
          className={`md:w-[43%] flex flex-col justify-center gap-5 md:gap-3 lg:gap-5 ${
            textInView
